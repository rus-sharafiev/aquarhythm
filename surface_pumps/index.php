...
<div id="category-container">
  <div id=category-title>
		...
		<div>ПОВЕРХНОСТНЫЕ НАСОСЫ</div>
	</div>
	<div id="category-description">
		Поверхностные насосы применяются для забора чистой воды из скважин,
		 колодцев, открытых водоёмов и других источников водоснабжения,
		 а также для создания и поддержания давления в системах водоснабжения
		 в составе авто-матических насосных станций.</div>
...
WHERE category LIKE 'ПОВЕРХНОСТНЫЕ НАСОСЫ'
ORDER BY series";
