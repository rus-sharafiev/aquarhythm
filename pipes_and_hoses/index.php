...
<div id="category-container">
  <div id=category-title>
		...
		<div>ТРУБЫ И ШЛАНГИ</div>
	</div>
	<div id="category-description">
		ПНД ТРУБЫ UNIPUMP предназначены для транспортировки
		технической и питьевой воды, изготовлены из 100-процентного первичного полиэтилена. Шланги поливочные UNIPUMP
		применяются в качестве гибких трубопроводов для подачи
		питьевой и технической воды.<br><br>
		Данная продукция изготовлена на собственной производственной базе в России — «БАВЛЕНСКОМ
...
WHERE category LIKE 'ТРУБЫ И ШЛАНГИ'
ORDER BY series";
