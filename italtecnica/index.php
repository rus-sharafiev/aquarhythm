...
<div id="category-container">
  <div id=category-title>
		...
		<div>ITALTECNICA<br>АВТОМАТИКА ДЛЯ ВОДЯНЫХ НАСОСОВ</div>
	</div>
	<div id="category-description">
		Концерн ITALTECNICA — мировой лидер по производству автоматики для водяных насосов.
	</div>
...
WHERE category LIKE 'ITALTECNICA'";
