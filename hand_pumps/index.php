...
<div id="category-container">
  <div id=category-title>
		...
		<div>РУЧНЫЕ НАСОСЫ</div>
	</div>
	<div id="category-description">
		Ручные насосы предназначены для подъема воды из колодцев
		и скважин. Насосы не создают давления на выходе и служат
		только для подъёма и наполнения емкостей, которые устанавливаются под сливной патрубок.
	</div>
...
WHERE category LIKE 'РУЧНЫЕ НАСОСЫ'
ORDER BY series";
