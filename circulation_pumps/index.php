...
<div id="category-container">
  <div id=category-title>
	...
	<div id="category-description">
		Циркуляционные насосы с «мокрым» ротором предназначены 
		для создания принудительной циркуляции жидкости в одно- 
		или двухтрубных системах отопления или горячего водоснабжения 
		при стабильном или слабоменяющемся расходе.
	</div>
...
WHERE category LIKE 'ЦИРКУЛЯЦИОННЫЕ НАСОСЫ'
ORDER BY series";
